...
import { UpdateCategoryInputValidator } from "../validators/updateCategoryInputValidator";
const tag = "movies-dashboard-be:category:updateCategoryMiddleware";
export class UpdateCategoryMiddleware implements NestMiddleware {
    public use(req: any, res: any, next: () => void) {
        try {
            const validateRequestBody = new UpdateCategoryInputValidator().validateInputs(req.body);
