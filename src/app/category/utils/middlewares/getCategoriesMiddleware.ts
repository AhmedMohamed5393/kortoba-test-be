...
import { GetCategoriesInputValidator } from "../validators/getCategoriesInputValidator";
const tag = "movies-dashboard-be:category:getcategoriesMiddleware";
export class GetCategoriesMiddleware implements NestMiddleware {
    public use(req: any, res: any, next: () => void) {
        try {
            const validateRequestBody = new GetCategoriesInputValidator().validateInputs(req.query);
